...
def load_model():
    ...
    if request.method == "POST" and form.validate_on_submit():
        ...
        body_elements = ["<center> <p>", "El modelo entrenado para el clasificador: <strong>", complement, "</strong>", " fue cargado correctamente.</p>", "<a href='/clasificar' class='button alt'>Clasificar datos</a>", "</center>"
                         ]
